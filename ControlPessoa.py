...
class ControlPessoa:
    #Metodo construtor
    def __init__(self):
        self.pessoaUm = ModelPessoa#Criando uma chave para acessar os métodos da classe MetodoPessoa
        self.opcao = -1
        self.atu = 0
    ...
    def cadastrar(self):
        ...
        #Chamar o método Catrastrar Pessoa
    ...
    def atualizar(self):
       ...
       if self.atu == 1:
           ...
           print("Escolha uma opção etre 1 e 4")
    ...
    def operacao(self):
        while self.opcao != 0:
            self.menu() #Mostrar as opçoes para o usuário
            if self.opcao == 1:
                self.cadastrar()
            elif self.opcao == 2:
                self.consultar()
                ...
                print("Escolha oma opção entre 1 e 4! ")
